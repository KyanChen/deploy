...
def parse_args():
    ...
    parser.add_argument('--onnx_path', default='results/deploy/end2end.onnx', help='ONNX model path')
    parser.add_argument('--output_prefix', default='results/deploy/end2end.trt', help='output TensorRT engine prefix')
