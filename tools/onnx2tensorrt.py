...
def parse_args():
    ...
    parser.add_argument('--onnx_path', default='results/onnxdeployfull/end2end.onnx', help='ONNX model path')
    parser.add_argument('--output_prefix', default='results/onnxdeployfull/end2end_fp16', help='output TensorRT engine prefix')
